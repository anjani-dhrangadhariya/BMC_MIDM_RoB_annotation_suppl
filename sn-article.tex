...
\label{sec:generic}
%
The information to answer this question should usually be found in the Methods section (prioritized in the green arrow). 
If the information was not found in the section mentioned in the green arrow, try to search for it in the section mentioned in the yellow arrow.
%
%
%
