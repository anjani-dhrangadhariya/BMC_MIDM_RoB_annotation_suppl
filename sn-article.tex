...
\label{sec:dom2}
%
The second risk domain of the RoB 2 tool (Bias due to deviations from intended interventions) assesses the risk of bias due to deviations from the intended interventions, specifically focusing on the effect of the assigned intervention.
...
\label{sec:dom3}
%
Risk domain 3 (Bias due to missing outcome data) in the RoB 2 tool assesses the risk of bias associated with missing or incomplete outcome data in a study.
...
\label{sec:dom4}
%
Risk domain 4 (Bias in the measurement of the outcome) in the RoB 2 tool focuses on assessing the risk of bias related to the measurement of the outcome of interest in a study.
