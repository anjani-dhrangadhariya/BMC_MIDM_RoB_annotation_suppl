...
\begin{center}
 ...
 \centering
    ...
    Nr. & Study reference \\
    \hline
    1 & Single high-dose buprenorphine for opioid craving during withdrawal~\cite{ahmadi2018single} \\
    \hline
    2 & The effect of Kinesio taping on back pain in patients with Lenke Type 1 adolescent idiopathic scoliosis: A randomized controlled trial~\cite{atici2017effect} \\
    \hline
    3 & A Randomised Controlled Trial to Evaluate the Administration of the Health Improvement Card as a Health Promotion Tool: A Physiotherapist-Led Community-Based Initiative~\cite{bai2020randomised} \\
    \hline
    4 & Evaluation of RESPOND, a patient-centred program to prevent falls in older people presenting to the emergency department with a fall: A randomised controlled trial~\cite{barker2019evaluation} \\
    \hline
    5 & Community-based football in men with prostate cancer: 1-year follow-up on a pragmatic, multicentre randomised controlled trial~\cite{bjerre2019community}\\
    \hline
    6 & A multifactorial interdisciplinary intervention reduces frailty in older people: randomized trial~\cite{cameron2013multifactorial} \\
    \hline
    7 & LThe prevention of musculoskeletal complaints: long-term effect of a work-related psychosocial coaching intervention compared to physiotherapy alone-a randomized controlled trial~\cite{becker2020prevention} \\
    \hline
    8 & A single-oral bolus of 100,000 IU of cholecalciferol at hospital admission did not improve outcomes in the COVID-19 disease: the COVID-VIT-D-a randomised multicentre international clinical trial~\cite{cannata2022single} \\
    \hline
    9 & Effect of a Nutrition Supplement and Physical Activity Program on Pneumonia and Walking Capacity in Chilean Older People: A Factorial Cluster Randomized Trial~\cite{dangour2011effect} \\
    \hline
    10 & The Fear Reduction Exercised Early (FREE) approach to management of low back pain in general practice: A pragmatic cluster-randomised controlled trial~\cite{darlow2019fear} \\
    \hline
    11 & Aerobic training for improved memory in patients with stress-related exhaustion: a randomized controlled trial~\cite{eskilsson2017aerobic} \\
    \hline
    12 & Trunk stabilising exercises promote sternal stability in patients after median sternotomy for heart valve surgery: a randomised trial~\cite{felaya2022trunk} \\
    \hline
    13 & Effectiveness of chest physiotherapy in infants hospitalized with acute bronchiolitis: a multicenter, randomized, controlled trial~\cite{gajdos2010effectiveness} \\
    \hline
    14 & Long-term survival and dialysis dependency following acute kidney injury in intensive care: extended follow-up of a randomized controlled trial~\cite{gallagher2014long} \\
    \hline
    15 & Exercise Training and Weight Gain in Obese Pregnant Women: A Randomized Controlled Trial (ETIP Trial)~\cite{garnaes2016exercise}\\
    \hline
    16 & Effects of Hormone Therapy on Cognition and Mood in Recently Postmenopausal Women: Findings from the Randomized, Controlled KEEPS-Cognitive and Affective Study~\cite{gleason2015effects} \\
    \hline
    17 & Evaluation of a very brief pedometer-based physical activity intervention delivered in NHS Health Checks in England: The VBI randomised controlled trial~\cite{hardeman2020evaluation} \\
    \hline
    18 & Effect of a Primary Care Walking Intervention with and without Nurse Support on Physical Activity Levels in 45- to 75-Year-Olds: The Pedometer And Consultation Evaluation (PACE-UP) Cluster Randomised Clinical Trial~\cite{harris2017effect} \\
    \hline
    19 & Digitally enabled aged care and neurological rehabilitation to enhance outcomes with Activity and MObility UsiNg Technology (AMOUNT) in Australia: A randomised controlled trial~\cite{hassett2020digitally} \\
    \hline
    20 & MINDflex Training for Cognitive Flexibility in Chronic Pain: A Randomized, Controlled Cross-Over Trial~\cite{jacobsen2020mindflex} \\
    \end{tabular}
      \caption{The table lists the randomized controlled trials included in our pilot annotation corpus.}\label{tab:corpus_studies}
 \end{table*}   
\end{center}
